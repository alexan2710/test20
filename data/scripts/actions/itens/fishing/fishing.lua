fishingTable = {
	["waters"] = { 4614, 4615, 4616, 4617, 4618, 4619, 4608, 4609, 4610, 4611, 4612, 4613, 7236, 4614, 4615, 4616, 4617, 4618, 4619, 4665, 4666, 4820, 4821, 4822, 4823, 4824, 4825, 23765, 23766},
...
function ActionFish.onUse(player, item, fromPosition, target, toPosition)
	if not table.contains(fishingTable.waters, getTileInfo(toPosition).itemid) then
	...
	if table.contains(fishingTable.waters, getTileInfo(getThingPos(player)).itemid) then
